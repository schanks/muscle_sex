...
** 12004:  non-Finnish (METSIM MHUC-901, born in France, 'finnish'=0)
** 22011:  female NGT 1st degree relative of retained female IGT 22012
** 32071:  female NGT 1st degree relative of retained female IGT 32074
...
head(all1)
#  labelcode all.nuc rna.nuc atac.nuc
#1 12031           6       6       NA
#2 12049           7       7       NA
#3 32022           9       9       NA
#4 12010         120      12      108
...
head(all0, 15)
#  labelcode all.nuc rna.nuc atac.nuc
#1 12031           6       6       NA Drop from all analyses
#2 12049           6       6       NA Drop from all analyses
#3 32022           9       9       NA Drop from all analyses
#4 12010         120      12      108 Drop from RNA analyses ***  
#5 12178         289     122      167 
#6 32033         327     208      119
#7 32095         371     197      174
# 8 32008         383     173      210
# 9 22024         436     158      278
#10 12017         458     227      231
#11 12139         474     251      223
#12 12038         495     219      276
#13 12183         501     168      333
#14 12179         535      69      466 ***
#15 12080         537     262      275
#  *** in ATAC but not RNA or BOTH
...
* 22024 is very high in adipocytes (+10.7) and endothelial (+7.4) NGT female 62y, BMI is 24.3      
* 12072 is very high for smooth muscle (+11.5) and mesenchymal (+6.4)  T2D male 62y BMI 30.0, COMPLICATIONS nausea  
* 12094 is very high for neuromuscular junction (+10.97).  T2D male 57y BMI 29.7, COMPLICATIONS hard muscle training  

* 12082 z+5.005 NMJ
* 12101 z+5.28 Macrophage
* 12133 z+5.98 Mesenchymal
* 12170 z+5.62 Smooth muscle
* 32003 z+5.08 Neuronal
* 32007 z+5.01 Mesenchymal 
...
```
Of the 9 cell type proportion outliers based on RNA nuclei, 6 were outliers for proportions based on the combined RNA+ATAC nuclei   

* 22024 is very high in adipocytes Z=14.2 (and endothelial and macrophage).        
* 12072 is very high for smooth muscle Z=11.6 (and endothelial and mesenchymal). COMPLICATIONS nausea    
* 12094 is very high for neuromuscular junction Z=11.8. COMPLICATIONS hard muscle training   
* 12101 z +5.02 Macrophage
* 12133 z +7.74 Mesenchymal stem cell and +5.016 Macrophage
* 12170 z +5.48 Smooth muscle

The 3 RNA outliers that are not RNA+ATAC outliers are  
 
* 12095 high for T_cell Z=8.03, COMPLICATIONS might have smoked 
* 22014 high for T_cell Z=5.79
* 32024 high for Neuronal Z=5.98 


## How many samples are outliers for z of cell type proportions made from ATAC nuclei?
...
```
Of the 8 cell type proportion outliers based on ATAC nuclei, 3 are also outliers for at least one cell type proportion based on the RNA+ATAC. None for RNA only nuclei.  Only 2 are outliers only for ATAC nuclei - and BOTH have relatively few ATAC nuclei:  

* 22024 is high for adipocytes Z=5.8    
* 12072 is very high for smooth muscle Z=10.04 (and mesenchymal). COMPLICATIONS nausea    
* 12094 is very high for neuromuscular junction Z=8.72. COMPLICATIONS hard muscle training   


The 5 samples outliers for ATAC nuclei proportions are: 
* 12010 for THREE ATAC cell types - very high for T-cell (Z=10.56) and Adipocyte (Z=9.38) also for macrophage (Z=6.82), 58y female IGT, BMI=32.0 , only 108 atac nuclei
* 12082 Z=7.67 for neuromuscular junction
* 32003 Z=5.10 for neuronal
* 32007 Z=5.16 for mesenchymal stem cell
* 32033 very high for endothelial ATAC (Z=9.34)


HMMM - 3 had "COMPLICATIONS=Y", ALL ARE MALE T2D

* 12072 (personid 28694) "nausea, were given juice (<0.5dl) before skin and fat-biopsy")
* 12094 (personid 28669) "hard muscle training at the gym on the previous day"
* 12095 (personid 28683) "Might have smoked in the morning - althouth denies it..."
