...
#  No Adipocyte, No T_cell (and no MFM as of 11/15/2022)
...
file=paste0("~/sn_muscle_2023/output/DESeq.RNA/final_drop10nuc/results/",celltype[i],".",traits2[j],".results.tab"), sep="\t", quote=F, col.names=T, row.names=F)
