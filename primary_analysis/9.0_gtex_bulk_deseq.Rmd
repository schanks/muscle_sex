...
I would like to include a comparison between our bulk data and GTEx. I have downloaded the relevant GTEx v8 files here:
/net/snowwhite/home/schanks/muscle/gtex


Would you please be willing to run the bulk DESeq pipeline for this data (same gene exclusions)? I am thinking of the following model to best match our own:

Count ~ Sex + Age + Hardy Scale (these three from phenotype file) + SMRIN + SMNABTCH + SMCENTER (these three from the attributes file)

We won't have cell type proportion estimates for this, but they don't seem to have a dramatic effect on most genes anyways. Please let me know if you need anything else. 

Thanks,
Sarah
Running only sex.  Restricting to bulk genes with 5 counts in at least 25% of the samples. 
