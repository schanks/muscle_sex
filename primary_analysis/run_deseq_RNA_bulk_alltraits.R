...
heather<-read_csv("~/sn_muscle_2023/data/tissue.csv") %>% select(labelcode, all_of(h.traits))
...
file=paste0("~/sn_muscle_2023/output/DESeq.RNA/bulk_adjprop/hg38.filter22323.bulk.",traits2[j],".results.tab"), sep="\t", quote=F, col.names=T, row.names=F)
